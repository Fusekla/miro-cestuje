  ...
  days: [
    {
      ...
      transport: [
        { label: "Airport transfer", duration: "Edinburgh Airport to the city centre approx. 30 minutes" },
      ],
      highlightImage: {
    ...
    },
    {
      ...
      transport: [{ label: "Walking", duration: "Old Town and central Edinburgh for most of the day" }],
      highlightImage: {
    ...
    },
    {
      ...
      transport: [
        ...
        { label: "Train", duration: "Glasgow to Oban via the West Highland Line approx. 3 hours" },
      ],
      highlightImage: {
      ...
      fixedItems: [
        {
          time: "16:35",
          title: "West Highland Line departs Glasgow Queen Street",
        },
        {
          time: "19:40",
          title: "Arrive Oban",
    ...
    },
    {
      ...
      tags: ["harbour town", "viewpoints", "distillery"],
      transport: [{ label: "Walking", duration: "Oban town and harbour for most of the day" }],
      highlightImage: {
    ...
    },
    {
      ...
      transport: [
        { label: "Ferry", duration: "Oban to Craignure return with fixed sailing times" },
        { label: "Bus", duration: "Craignure to Tobermory return with fixed island timings" },
      ],
      highlightImage: {
      ...
      fixedItems: [
        {
          time: "08:05",
          title: "Oban ferry check-in closes",
        },
        {
          time: "09:55",
          title: "Bus 95 departs Craignure for Tobermory",
        },
        {
          time: "14:20",
          title: "Bus 95 departs Tobermory for Craignure",
        },
        {
          time: "15:30",
          title: "Craignure ferry check-in closes",
        },
      ],
      notes: [
      ...
      sections: [
        {
          ...
          items: [
            { text: "Breakfast and walk to the ferry terminal." },
            {
              ...
              duration: "Arrives 09:35",
            },
            {
              time: "09:55",
              text: "Bus 95 across Mull to Tobermory.",
            },
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: "Walk out to Rubha nan Gall lighthouse for views back across Tobermory Bay and the Sound of Mull.",
            },
            { time: "14:20", text: "Bus 95 back from Tobermory toward Craignure." },
            { time: "15:40", text: "Ferry from Craignure back to Oban." },
          ],
        },
        {
          title: "Evening",
    ...
    },
    {
      ...
      tags: ["islands", "boat excursion", "demanding"],
      transport: [
        { label: "Ferry", duration: "Oban to Craignure return with an early start" },
        { label: "Coach", duration: "Craignure to Fionnphort return across Mull" },
        { label: "Boat", duration: "Lunga, Staffa, and Iona circuit for most of the day" },
      ],
      highlightImage: {
      ...
      fixedItems: [
        {
          time: "06:55",
          title: "Oban ferry check-in closes",
          note: "Collect CalMac tickets before sailing.",
        },
      ],
      notes: [
    ...
    },
    {
      ...
      tags: ["glencoe", "history", "day trip"],
      transport: [
        { label: "Bus", duration: "Fort William to Glencoe return for most of the day" },
      ],
      highlightImage: {
      ...
      fixedItems: [
        {
          time: "09:10",
          title: "Citylink 915 departs Fort William",
          note: "Glencoe Visitor Centre.",
        },
        {
          time: "16:35",
          title: "Citylink 915 departs Glencoe",
          note: "Outside Hotel.",
        },
      ],
      notes: [
    ...
    },
    {
      ...
      tags: ["transfer", "Loch Ness", "castle stop"],
      transport: [
        { label: "Bus", duration: "Fort William to Urquhart Castle to Inverness in two stages" },
      ],
      highlightImage: {
      ...
      fixedItems: [
        {
          time: "09:35",
          title: "Citylink 919 departs Fort William",
          note: "Arrives at Urquhart Castle at 11:01.",
        },
        { time: "11:30", title: "Urquhart Castle timed entry" },
        {
          time: "13:15",
          title: "Citylink 919 departs Urquhart Castle",
          note: "Onward to Inverness.",
        },
      ],
      sections: [
        {
    ...
    },
    {
      ...
      transport: [
        { label: "Bus", duration: "Inverness to Culloden return, short local ride" },
      ...
      fixedItems: [
        {
          time: "16:25",
          title: "ScotRail departs Inverness",
          note: "Arrives in Aviemore at 17:06.",
        },
      ],
      sections: [
        {
    ...
    },
    {
      ...
      fixedItems: [
        {
          time: "12:45",
          title: "Strathspey Railway departs Aviemore",
          note: "Return arrives back in Aviemore at 14:27.",
        },
        {
          time: "16:27",
          title: "ScotRail departs Aviemore",
          note: "Arrives 19:43 with one change.",
        },
      ],
      notes: [
        ...
        },
        {
          ...
          items: [
            { text: "Lunch around Aviemore or Rothiemurchus." },
            {
              ...
              duration: "Returns 14:27",
              fixed: true,
            },
            { text: "Short pause back in Aviemore, then pack and leave enough buffer to reach the station." },
            {
              time: "16:27",
    ...
    },
    {
      ...
      transport: [{ label: "Airport transfer", duration: "City centre to Edinburgh Airport approx. 30-40 minutes" }],
      highlightImage: {
